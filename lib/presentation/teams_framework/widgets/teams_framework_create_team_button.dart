...
class TeamsFrameworkCreateTeamButton extends StatelessWidget {
  const TeamsFrameworkCreateTeamButton({Key? key}) : super(key: key);
      ...
      child: CoreTextButton(
        callback: () {
          context.read<TeamsFrameworkBloc>().add(
                const TeamsFrameworkEvent.createTeam(),
              );
        },
        text: 'failure',
      ),
