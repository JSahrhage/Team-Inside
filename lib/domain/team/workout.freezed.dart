...
abstract class $WorkoutCopyWith<$Res> {
  ...
  $Res call({UniqueId id, KtList<EvaluationEntry> evaluationEntries});
}
...
class _$_Workout extends _Workout {
  const _$_Workout({required this.id, required this.evaluationEntries})
      : super._();
  ...
  @override
  String toString() {
    return 'Workout(id: $id, evaluationEntries: $evaluationEntries)';
  }
